...
<SlidesAccessCard
  title="Open the companion workshop deck"
  ...
  caption="Use the written docs as the operating guide, then open the deck when you want a slide-based walkthrough for workshops, reviews, or team kickoff sessions."
/>
